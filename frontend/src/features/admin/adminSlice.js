...
export const updateUserRole = createAsyncThunk(
  ...
  async ({ userId, role }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data || "Failed to updata user role",
      );
    }
  },
);
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(getSingleUser.rejected, (state, action) => {
        ((state.loading = false),
          (state.error =
            action.payload?.message || "Failed to fetch users info"));
      });
    builder
      ...
      .addCase(updateUserRole.rejected, (state, action) => {
        ((state.loading = false),
          (state.error =
            action.payload?.message || "Failed to updata user role"));
      });
    builder
    ...
    builder
      ...
      .addCase(updateorderStatus.rejected, (state, action) => {
        ((state.loading = false),
          (state.error =
            action.payload?.message || "Failed to Update Orders Status"));
      });
    builder
    ...
    builder
      ...
      .addCase(deleteReviews.rejected, (state, action) => {
        ((state.loading = false),
          (state.error =
            action.payload?.message || "Failed to Delete Product Reviews"));
      });
  },
});
